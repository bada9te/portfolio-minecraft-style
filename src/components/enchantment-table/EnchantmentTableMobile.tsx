...
export default function EnchantmentTableMobile({ placedTechnology, setPlacedTechnology, determineTooltip, techImages }: IEnchantmentTableProps){
    ...
    return (
        <div className={"absolute inset-0 w-screen h-[80vh] bg-[#8A7F79] border-4 border-gray-700 border-l-white"}>
            <div className={"w-full h-full relative"}>
                ...
                <div className={"w-full h-full pt-14 flex gap-0 items-center justify-center"}>
                    <div className={"w-full h-full flex flex-col gap-0 max-w-[660px]"}>

                        <div className={"flex flex-row px-4 max-w-[660px]"}>
                            <div className={"w-fit flex flex-col max-h-[calc(100%-24px)] mt-3 relative"}>
                                ...
                                <Image
                                    ...
                                    className={"absolute top-40 left-[70%] -translate-x-1/2 min-w-36"}
                                />
                            </div>
                        ...
                        <div className={"max-w-[660px] flex flex-row items-center justify-start md:justify-center flex-wrap p-3 max-h-[calc(100%-24px)] overflow-auto"}>
                            {
