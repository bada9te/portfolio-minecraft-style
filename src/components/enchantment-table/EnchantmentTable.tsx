...
export interface IEnchantmentTableProps {
    placedTechnology: string | null;
    setPlacedTechnology: (a: string | null) => void;
    determineTooltip: (imgUrl: string) => string;
    techImages: string[];
}


export default function EnchantmentTable({ placedTechnology, setPlacedTechnology, determineTooltip, techImages }: IEnchantmentTableProps){
    ...
    return (
        <div className={"w-screen h-screen relative"}>
            ...
            <div className={`
                    ...
                    w-full max-w-xl h-fit bg-[#C7C7C7] border-3 border-black
                `}>
                <div className={"w-full h-full flex flex-col items-center justify-start gap-4 border-4 border-white border-b-gray-700 border-r-gray-700"}>
                        <span className={"text-[#414141] w-full text-start p-3 text-2xl"}>
                            Enchant
                        </span>
